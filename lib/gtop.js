...
//   }
// })
var netSpark = grid.set(4, 0, 3, 12, contrib.sparkline, {
...
var diskDonut = grid.set(7, 0, 2, 4, contrib.donut, {
  radius: 8,
  arcWidth: 3,
  yPadding: 2,
  remainColor: 'black',
...
var memDonut = grid.set(7, 4, 2, 4, contrib.donut, {
  radius: 8,
  arcWidth: 3,
  yPadding: 2,
  remainColor: 'black',
...
var swapDonut = grid.set(7, 8, 2, 4, contrib.donut, {
  radius: 8,
  arcWidth: 3,
  yPadding: 2,
  remainColor: 'black',
...
var procTable = grid.set(9, 0, 3, 12, contrib.table, {
  keys: true,
  label: 'Processes',
  columnSpacing: 1,
...
function init() {
  ...
  new monitor.Mem(memDonut, swapDonut);
